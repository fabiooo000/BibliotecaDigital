...
var preguntas = [
    {
        ...
        opciones: ["Mario Vargas Llosa", "Gabriel García Márquez", "Julio Cortázar", "Jorge Luis Borges"],
        correcta: 1
    },
    {
        texto: "¿Autor de libro '1984'?",
        opciones: ["Aldous Huxley", "George Orwell", "Ray Bradbury", "H.G. Wells"],
        correcta: 1
    },
    {
        texto: "¿Quién escribió 'Don Quijote de la Mancha'?",
        opciones: ["Lope de Vega", "Miguel de Cervantes", "Calderón de la Barca", "Góngora"],
        correcta: 1
    },
    {
        texto: "¿Autor de 'La Metamorfosis'?",
        opciones: ["Franz Kafka", "Thomas Mann", "Hermann Hesse", "Stefan Zweig"],
        correcta: 0
    },
    {
        texto: "¿Quién escribió 'Mujercitas'?",
        opciones: ["Jane Austen", "Charlotte Brontë", "Louisa May Alcott", "Emily Dickinson"],
        correcta: 2
    }
];
...
function verificarRespuesta(seleccion, botonSeleccionado) {
    ...
    // Deshabilitar los botones primero
...
function mostrarResultado() {
    ...
    if (porcentaje === 1) {
        mensaje = "¡Perfecto! Dominas a los autores clásicos.";
    } else if (porcentaje >= 0.8) {
        mensaje = "¡Muy bien! Tienes excelentes conocimientos.";
